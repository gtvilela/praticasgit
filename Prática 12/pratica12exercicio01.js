...
function mascaraData (objeto, evento) {
    /*  0 keyCode não é compatível com todos navegadores.
    ...
    */
    ...
    //Impede a inserção de novos caracteres quando o string alcança o tamanho de 10 caracteres.
...
function verificarFormulario() { 
    ...
    if (document.getElementByld ("escolaridade").value == "") { 
